...
import 'package:store_values/database_helper.dart';
...
//final data = await DatabaseHelper.getItems();
    myData = await DatabaseHelper.getItems();
    setState(() {
      // myData = data;
      _isLoading = false;
    });
...
// Insert a new data to the database
  ...
  void deleteItem(int id) async {
    ...
    ScaffoldMessenger.of(context)
        .showSnackBar(const SnackBar(content: Text('Successfully deleted!'), backgroundColor: Colors.red));
    _refreshData();
  }
